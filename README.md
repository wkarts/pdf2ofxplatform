...
ghcr.io/wkarts/pdf2ofxplatform:latest

## Pull da imagem

Se o package estiver publico:

docker pull ghcr.io/wkarts/pdf2ofxplatform:latest
...
org.opencontainers.image.source=https://github.com/wkarts/pdf2ofxplatform
